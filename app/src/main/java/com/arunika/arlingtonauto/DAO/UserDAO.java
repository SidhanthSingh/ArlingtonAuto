...
public class UserDAO {
    ...
    public static long insertUser(User user) {
        ...
        values.put(DBHelper.COLUMN_DRIVING_LICENSE_NUMBER, user.getDrivingLicenseNumber());
    ...
    public static User getUser(String username) {
        ...
        if (cursor.moveToFirst()) {
            ...
            user.setDrivingLicenseNumber(cursor.getString(cursor.getColumnIndex(DBHelper.COLUMN_DRIVING_LICENSE_NUMBER)));
        }
        cursor.close();
        return user;
    }
...
//                +DBHelper.COLUMN_DRIVING_LICENSE_NUMBER+"="+user.getDrivingLicenseNumber()+","
