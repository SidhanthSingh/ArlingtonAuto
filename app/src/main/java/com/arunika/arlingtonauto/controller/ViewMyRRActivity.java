...
public class ViewMyRRActivity extends BaseMenuActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_rr_list_item);
...
//        listView.setAdapter(customAdapter);
    ...
    public void cancelButton(View view) {
        Toasty.success(getApplicationContext(), "Successfully Cancelled!", Toast.LENGTH_SHORT, true).show();
        Intent a = new Intent(this,CustomerHomeActivity.class);
