...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private EditText drivingLicenseNumber;
    ...
    private void initViews() {
        ...
        this.drivingLicenseNumber = findViewById(R.id.drivingLicenseNumber);
    }
    ...
    public void onRegister(View view) {
        ...
        user.setDrivingLicenseNumber(drivingLicenseNumber.getText().toString());
